defmodule Dispatcher do
  ...
  get "/subcases/:subcase_id/agendas", @json_service do
    Proxy.forward conn, [], "http://agenda-submission/subcases/" <> subcase_id <> "/agendas"
  end
  ...
  get "/file-bundling-jobs/*path", @json_service do
